...
def resultsScraper(countyCode, precinctCodes):
    ...
    response = get(
        'https://electionresults.sos.state.mn.us/Results/PrecinctListResults/118?countyid=' + countyCode + '&precincts=' + precincts)
...
def precinctCodes(countyCode, reportedPrecincts):
    ...
    # Specificy URL
    response = get('https://electionresults.sos.state.mn.us/Select/CountyPrecinctSelect/118?districtid=' + countyCode)
...
while True:
    ...
    # URL
    URL = 'https://electionresults.sos.state.mn.us/Results/CountyStatistics/118'
    ...
    for county in counties_reported:
        ...
        county_entry = "INSERT INTO sd11special (county, precinct, office, party, candidate, raw_votes, percentage) values "
